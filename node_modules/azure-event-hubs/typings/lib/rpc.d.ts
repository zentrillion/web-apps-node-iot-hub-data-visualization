import { ReceiverOptions, SenderOptions, OnAmqpEvent, Connection } from "./rhea-promise";
...
export declare function sendRequest(connection: any, link: RequestResponseLink, request: Message, timeoutInSeconds?: number): Promise<any>;
/**
 ...
 */
export declare function open(params: CreateConnectionPrameters): Promise<Connection>;
