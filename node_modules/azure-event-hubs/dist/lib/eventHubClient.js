...
class EventHubClient {
    ...
    static createFromIotHubConnectionString(iothubConnectionString, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connectionString = yield new iothubClient_1.IotHubClient(iothubConnectionString).getEventHubConnectionString();
    ...
    static createFromAadTokenCredentials(host, entityPath, credentials, options) {
        ...
        clientOptions.tokenProvider = new aad_1.AadTokenProvider(credentials);
